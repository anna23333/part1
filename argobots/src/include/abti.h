...
struct ABTI_global {
    ...
    int *empty_list;        //if there is the request to empty this pool, set this num as 1.
...
void ABT_es_info(ABTI_xstream *p_xstream) ABT_API_PUBLIC;
