...
int ABT_xstream_check(ABT_pool *pools, ABT_pool pool, int *run_cnt, ABT_sched sched) ABT_API_PUBLIC; 
void ABT_info(ABT_pool *pools, int check_num) ABT_API_PUBLIC;
void ABT_print_my_info(ABT_pool *pools) ABT_API_PUBLIC; 
void ABT_print_my_sched(ABT_sched sched) ABT_API_PUBLIC;
void ABT_check_pool(ABT_pool *pools, int check_num) ABT_API_PUBLIC;
int ABT_my_migrate(ABT_pool *pools, ABT_sched sched, int *run_cnt) ABT_API_PUBLIC;
int ABT_my_migrate2(ABT_pool *pools, ABT_sched sched, int *run_cnt) ABT_API_PUBLIC;
void ABT_set_s_info(ABT_sched sched) ABT_API_PUBLIC;
void ABT_set_r_info(ABT_sched sched) ABT_API_PUBLIC;
void ABT_get_info() ABT_API_PUBLIC;
void ABT_write_to_pipe(int fd_fifo) ABT_API_PUBLIC;
void ABT_pipe_set_info(ABT_sched sched) ABT_API_PUBLIC;
